...
function cal() {
    try {
        ...
        document.getElementById("x_oneamtFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .x_oneamtFiscalizadora.value) - (document.closecash_edit.x_oneamtSistema.value)).toFixed(2);
        document.getElementById("x_oneamtFiscalizadora_t").innerHTML = parseFloat((document.closecash_edit
            .x_oneamtFiscalizadora.value) * 1).toFixed(2);
        document.getElementById("x_fiveamtFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .x_fiveamtFiscalizadora.value) - (document.closecash_edit.x_fiveamtSistema.value)).toFixed(2);
        document.getElementById("x_fiveamtFiscalizadora_t").innerHTML = parseFloat((document.closecash_edit
            .x_fiveamtFiscalizadora.value) * 5).toFixed(2);
        document.getElementById("x_tenamtFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .x_tenamtFiscalizadora.value) - (document.closecash_edit.x_tenamtSistema.value)).toFixed(2);
        document.getElementById("x_tenamtFiscalizadora_t").innerHTML = parseFloat((document.closecash_edit
            .x_tenamtFiscalizadora.value) * 10).toFixed(2);
        document.getElementById("x_twentyamtFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .x_twentyamtFiscalizadora.value) - (document.closecash_edit.x_twentyamtSistema.value)).toFixed(2);
        document.getElementById("x_twentyamtFiscalizadora_t").innerHTML = parseFloat((document.closecash_edit
            .x_twentyamtFiscalizadora.value) * 20).toFixed(2);
        document.getElementById("x_fiftyamtFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .x_fiftyamtFiscalizadora.value) - (document.closecash_edit.x_fiftyamtSistema.value)).toFixed(2);
        document.getElementById("x_fiftyamtFiscalizadora_t").innerHTML = parseFloat((document.closecash_edit
            .x_fiftyamtFiscalizadora.value) * 50).toFixed(2);
        document.getElementById("x_hundredamtFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .x_hundredamtFiscalizadora.value) - (document.closecash_edit.x_hundredamtSistema.value)).toFixed(2);
        document.getElementById("x_hundredamtFiscalizadora_t").innerHTML = parseFloat((document.closecash_edit
        ...
        document.getElementById("x_oneamtGerente_r").innerHTML = parseFloat((document.closecash_edit
            .x_oneamtGerente.value) - (document.closecash_edit.x_oneamtFiscalizadora.value)).toFixed(2);
        document.getElementById("x_oneamtGerente_t").innerHTML = parseFloat((document.closecash_edit
            .x_oneamtGerente.value) * 1).toFixed(2);
        document.getElementById("x_fiveamtGerente_r").innerHTML = parseFloat((document.closecash_edit
            .x_fiveamtGerente.value) - (document.closecash_edit.x_fiveamtFiscalizadora.value)).toFixed(2);
        document.getElementById("x_fiveamtGerente_t").innerHTML = parseFloat((document.closecash_edit
            .x_fiveamtGerente.value) * 5).toFixed(2);
        document.getElementById("x_tenamtGerente_r").innerHTML = parseFloat((document.closecash_edit
            .x_tenamtGerente.value) - (document.closecash_edit.x_tenamtFiscalizadora.value)).toFixed(2);
        document.getElementById("x_tenamtGerente_t").innerHTML = parseFloat((document.closecash_edit
            .x_tenamtGerente.value) * 10).toFixed(2);
        document.getElementById("x_twentyamtGerente_r").innerHTML = parseFloat((document.closecash_edit
            .x_twentyamtGerente.value) - (document.closecash_edit.x_twentyamtFiscalizadora.value)).toFixed(2);
        document.getElementById("x_twentyamtGerente_t").innerHTML = parseFloat((document.closecash_edit
            .x_twentyamtGerente.value) * 20).toFixed(2);
        document.getElementById("x_fiftyamtGerente_r").innerHTML = parseFloat((document.closecash_edit
            .x_fiftyamtGerente.value) - (document.closecash_edit.x_fiftyamtFiscalizadora.value)).toFixed(2);
        document.getElementById("x_fiftyamtGerente_t").innerHTML = parseFloat((document.closecash_edit
            .x_fiftyamtGerente.value) * 50).toFixed(2);
        document.getElementById("x_hundredamtGerente_r").innerHTML = parseFloat((document.closecash_edit
            .x_hundredamtGerente.value) - (document.closecash_edit.x_hundredamtFiscalizadora.value)).toFixed(2);
        document.getElementById("x_hundredamtGerente_t").innerHTML = parseFloat((document.closecash_edit
        ...
        //otros
        if (isNaN(parseFloat(document.closecash_edit.otrosFiscalizadora.value))) {
            otrosFiscalizadora_suma = 0;
        } else {
            otrosFiscalizadora_suma = parseFloat(document.closecash_edit.otrosFiscalizadora.value);
        }
        if (isNaN(parseFloat(document.closecash_edit.otrosprimeroFiscalizadora.value))) {
            otrosprimeroFiscalizadora_suma = 0;
        } else {
            otrosprimeroFiscalizadora_suma = parseFloat(document.closecash_edit.otrosprimeroFiscalizadora.value);
        }
        //
        if (isNaN(parseFloat(document.closecash_edit.InvoiceAmtFiscalizadora.value))) {
            InvoiceAmtFiscalizadora_suma = 0;
        } else {
            InvoiceAmtFiscalizadora_suma = parseFloat(document.closecash_edit.InvoiceAmtFiscalizadora.value);
        }
        if (isNaN(parseFloat(document.closecash_edit.InvoiceAmtPropiasFiscalizadora.value))) {
            InvoiceAmtPropiasFiscalizadora_suma = 0;
        } else {
            InvoiceAmtPropiasFiscalizadora_suma = parseFloat(document.closecash_edit.InvoiceAmtPropiasFiscalizadora
                .value);
        }
        /// Inicializacion de Tarjetas
        if (isNaN(parseFloat(document.closecash_edit.CardClaveFiscalizadora.value))) {
            CardClaveFiscalizadora_suma = 0;
        } else {
            CardClaveFiscalizadora_suma = parseFloat(document.closecash_edit.CardClaveFiscalizadora.value);
        }
        if (isNaN(parseFloat(document.closecash_edit.CardValeFiscalizadora.value))) {
            CardValeFiscalizadora_suma = 0;
        } else {
            CardValeFiscalizadora_suma = parseFloat(document.closecash_edit.CardValeFiscalizadora.value)
        }
        if (isNaN(parseFloat(document.closecash_edit.CardVisaFiscalizadora.value))) {
            CardVisaFiscalizadora_suma = 0;
        } else {
            CardVisaFiscalizadora_suma = parseFloat(document.closecash_edit.CardVisaFiscalizadora.value);
        }
        if (isNaN(parseFloat(document.closecash_edit.CardMasterFiscalizadora.value))) {
            CardMasterFiscalizadora_suma = 0;
        } else {
            CardMasterFiscalizadora_suma = parseFloat(document.closecash_edit.CardMasterFiscalizadora.value);
        }
        if (isNaN(parseFloat(document.closecash_edit.CardAEFiscalizadora.value))) {
            CardAEFiscalizadora_suma = 0;
        } else {
            CardAEFiscalizadora_suma = parseFloat(document.closecash_edit.CardAEFiscalizadora.value);
        }
        if (isNaN(parseFloat(document.closecash_edit.CardBACFiscalizadora.value))) {
            CardBACFiscalizadora_suma = 0;
        } else {
            CardBACFiscalizadora_suma = parseFloat(document.closecash_edit.CardBACFiscalizadora.value);
        }
        ...
        document.getElementById("yappyFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .yappyFiscalizadora.value) - (document.closecash_edit.yappySistema.value)).toFixed(2);

        //otros
        document.getElementById("otrosFiscalizadora_r").innerHTML = parseFloat((otrosFiscalizadora_suma +
            otrosprimeroFiscalizadora_suma) - document.closecash_edit.otrosSistema.value).toFixed(2);
        //
        document.getElementById("valespagodaFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .valespagodaFiscalizadora.value) - (document.closecash_edit.valespagodaSistema.value)).toFixed(2);
        document.getElementById("CheckAmtFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .CheckAmtFiscalizadora.value) - (document.closecash_edit.CheckAmtSistema.value)).toFixed(2);
        document.getElementById("LotoAmtFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .LotoAmtFiscalizadora.value) - (document.closecash_edit.LotoAmtSistema.value)).toFixed(2);
        document.getElementById("CashAmtFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .CashAmtFiscalizadora.value) - (document.closecash_edit.CashAmtSistema.value)).toFixed(2);
        document.getElementById("CoinRollFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .CoinRollFiscalizadora.value) - (document.closecash_edit.CoinRollSistema.value)).toFixed(2);
        document.getElementById("VoucherAmtFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .VoucherAmtFiscalizadora.value) - (document.closecash_edit.VoucherAmtSistema.value)).toFixed(2);
        document.getElementById("GrantAmtFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .GrantAmtFiscalizadora.value) - (document.closecash_edit.GrantAmtSistema.value)).toFixed(2);
        document.getElementById("valeAmtFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
            .valeAmtFiscalizadora.value) - (document.closecash_edit.valeAmt.value)).toFixed(2);
        document.getElementById("InvoiceAmtFiscalizadora_r").innerHTML = parseFloat((InvoiceAmtFiscalizadora_suma +
            InvoiceAmtPropiasFiscalizadora_suma) - document.closecash_edit.InvoiceAmtSistema.value).toFixed(2);
        document.getElementById("CardClaveFiscalizadora_r").innerHTML = parseFloat(card - document.closecash_edit
            .CardAmtSistema.value).toFixed(2);
        document.getElementById("CardValeFiscalizadora_r").innerHTML = parseFloat(card - document.closecash_edit
            .CardAmtSistema.value).toFixed(2);
        document.getElementById("CardVisaFiscalizadora_r").innerHTML = parseFloat(card - document.closecash_edit
            .CardAmtSistema.value).toFixed(2);
        document.getElementById("CardMasterFiscalizadora_r").innerHTML = parseFloat(card - document.closecash_edit
            .CardAmtSistema.value).toFixed(2);
        document.getElementById("CardAEFiscalizadora_r").innerHTML = parseFloat(card - document.closecash_edit
            .CardAmtSistema.value).toFixed(2);
        document.getElementById("CardBACFiscalizadora_r").innerHTML = parseFloat(card - document.closecash_edit
        ...
        const cardg = parseFloat(parseFloat(document.closecash_edit.CardClaveGerente.value) + parseFloat(document
            .closecash_edit.CardValeGerente.value) + parseFloat(document.closecash_edit.CardVisaGerente
                .value) + parseFloat(document.closecash_edit.CardMasterGerente.value) + parseFloat(document
                    .closecash_edit.CardAEGerente.value) + parseFloat(document.closecash_edit.CardBACGerente
                        .value)).toFixed(2);
        ...
        if (isNaN(document.getElementById("CardClaveFiscalizadora_r").innerHTML)) {
            ...
            document.getElementById("CardClaveFiscalizadora_r").innerHTML = -(document.closecash_edit
                .CardAmtSistema.value);
        }
        if (isNaN(document.getElementById("CardValeFiscalizadora_r").innerHTML)) {
            //cambioCardVisaFiscalizadora.classList.replace("text-success", "text-white");
            document.getElementById("CardValeFiscalizadora_r").innerHTML = -(document.closecash_edit.CardAmtSistema
                .value);
        }
        if (isNaN(document.getElementById("CardVisaFiscalizadora_r").innerHTML)) {
            //cambioCardVisaFiscalizadora.classList.replace("text-success", "text-white");
            document.getElementById("CardVisaFiscalizadora_r").innerHTML = -(document.closecash_edit.CardAmtSistema
                .value);
        }
        if (isNaN(document.getElementById("CardMasterFiscalizadora_r").innerHTML)) {
            //cambioCardVisaFiscalizadora.classList.replace("text-success", "text-white");
            document.getElementById("CardMasterFiscalizadora_r").innerHTML = -(document.closecash_edit
                .CardAmtSistema.value);
        }
        if (isNaN(document.getElementById("CardAEFiscalizadora_r").innerHTML)) {
            //cambioCardVisaFiscalizadora.classList.replace("text-success", "text-white");
            document.getElementById("CardAEFiscalizadora_r").innerHTML = -(document.closecash_edit.CardAmtSistema
                .value);
        }
        /////////////////////////////////////////////////////////////////////////////////

        document.getElementById("CardClaveGerente_r").innerHTML = parseFloat(document.closecash_edit
            .CardClaveGerente.value - document.closecash_edit.CardClaveFiscalizadora.value).toFixed(2);
        document.getElementById("CardValeGerente_r").innerHTML = parseFloat(document.closecash_edit.CardValeGerente
            .value - document.closecash_edit.CardValeFiscalizadora.value).toFixed(2);
        document.getElementById("CardVisaGerente_r").innerHTML = parseFloat(document.closecash_edit.CardVisaGerente
            .value - document.closecash_edit.CardVisaFiscalizadora.value).toFixed(2);
        document.getElementById("CardMasterGerente_r").innerHTML = parseFloat(document.closecash_edit
            .CardMasterGerente.value - document.closecash_edit.CardMasterFiscalizadora.value).toFixed(2);
        document.getElementById("CardAEGerente_r").innerHTML = parseFloat(document.closecash_edit.CardAEGerente
            .value - document.closecash_edit.CardAEFiscalizadora.value).toFixed(2);
        ...
        document.getElementById("yappyGerente_r").innerHTML = parseFloat(document.closecash_edit.yappyGerente
            .value - document.closecash_edit.yappyFiscalizadora.value).toFixed(2);
        document.getElementById("otrosGerente_r").innerHTML = parseFloat(document.closecash_edit.otrosGerente
            .value - document.closecash_edit.otrosFiscalizadora.value).toFixed(2);
        //otros
        document.getElementById("otrosprimeroGerente_r").innerHTML = parseFloat(document.closecash_edit
            .otrosprimeroGerente.value - document.closecash_edit.otrosprimeroFiscalizadora.value)
            .toFixed(2);
        //
        document.getElementById("valespagodaGerente_r").innerHTML = parseFloat(document.closecash_edit
            .valespagodaGerente.value - document.closecash_edit.valespagodaFiscalizadora.value).toFixed(2);
        document.getElementById("CheckAmtGerente_r").innerHTML = parseFloat(document.closecash_edit.CheckAmtGerente
            .value - document.closecash_edit.CheckAmtFiscalizadora.value).toFixed(2);
        document.getElementById("LotoAmtGerente_r").innerHTML = parseFloat(document.closecash_edit.LotoAmtGerente
            .value - document.closecash_edit.LotoAmtFiscalizadora.value).toFixed(2);
        document.getElementById("CashAmtGerente_r").innerHTML = parseFloat(document.closecash_edit.CashAmtGerente
            .value - document.closecash_edit.CashAmtFiscalizadora.value).toFixed(2);
        document.getElementById("CardClaveGerente_r").innerHTML = parseFloat(document.closecash_edit
            .CardClaveGerente.value - document.closecash_edit.CardClaveFiscalizadora.value).toFixed(2);
        document.getElementById("CardValeGerente_r").innerHTML = parseFloat(document.closecash_edit.CardValeGerente
            .value - document.closecash_edit.CardValeFiscalizadora.value).toFixed(2);
        ...
        document.getElementById("CardAEGerente_r").innerHTML = parseFloat(document.closecash_edit.CardAEGerente
            .value - document.closecash_edit.CardAEFiscalizadora.value).toFixed(2);
        document.getElementById("CardBACGerente_r").innerHTML = parseFloat(document.closecash_edit.CardBACGerente
            .value - document.closecash_edit.CardBACFiscalizadora.value).toFixed(2);
        document.getElementById("CoinRollGerente_r").innerHTML = parseFloat(document.closecash_edit.CoinRollGerente
            .value - document.closecash_edit.CoinRollFiscalizadora.value).toFixed(2);
        document.getElementById("InvoiceAmtGerente_r").innerHTML = parseFloat(document.closecash_edit
            .InvoiceAmtGerente.value - document.closecash_edit.InvoiceAmtFiscalizadora.value).toFixed(2);
        document.getElementById("InvoiceAmtPropiasGerente_r").innerHTML = parseFloat(document.closecash_edit
            .InvoiceAmtPropiasGerente.value - document.closecash_edit.InvoiceAmtPropiasFiscalizadora.value)
            .toFixed(2);
        document.getElementById("VoucherAmtGerente_r").innerHTML = parseFloat(document.closecash_edit
            .VoucherAmtGerente.value - document.closecash_edit.VoucherAmtFiscalizadora.value).toFixed(2);
        document.getElementById("GrantAmtGerente_r").innerHTML = parseFloat(document.closecash_edit.GrantAmtGerente
            .value - document.closecash_edit.GrantAmtFiscalizadora.value).toFixed(2);
        document.getElementById("valeAmtGerente_r").innerHTML = parseFloat(document.closecash_edit.valeAmtGerente
            .value - document.closecash_edit.valeAmtFiscalizadora.value).toFixed(2);
        ...
        if (isNaN(parseFloat(document.closecash_edit.yappyGerente.value))) {
            yappyGerente_NaN = 0;
        } else {
            yappyGerente_NaN = parseFloat(document.closecash_edit.yappyGerente.value).toFixed(2);;
        }
        if (isNaN(parseFloat(document.closecash_edit.otrosGerente.value))) {
            otrosGerente_NaN = 0;
        } else {
            otrosGerente_NaN = parseFloat(document.closecash_edit.otrosGerente.value).toFixed(2);;
        }
        //otros
        if (isNaN(parseFloat(document.closecash_edit.otrosprimeroGerente.value))) {
            otrosprimeroPropiasGerente_NaN = 0;
        } else {
            otrosprimeroGerente_NaN = parseFloat(document.closecash_edit.otrosprimeroGerente.value)
                .toFixed(2);
        }
        //
        if (isNaN(parseFloat(document.closecash_edit.valespagodaGerente.value))) {
            valespagodaGerente_NaN = 0;
        } else {
            valespagodaGerente_NaN = parseFloat(document.closecash_edit.valespagodaGerente.value).toFixed(2);;
        }
        if (isNaN(parseFloat(document.closecash_edit.CheckAmtGerente.value))) {
            CheckAmtGerente_NaN = 0;
        } else {
            CheckAmtGerente_NaN = parseFloat(document.closecash_edit.CheckAmtGerente.value).toFixed(2);;
        }
        if (isNaN(parseFloat(document.closecash_edit.LotoAmtGerente.value))) {
            LotoAmtGerente_NaN = 0;
        } else {
            LotoAmtGerente_NaN = parseFloat(document.closecash_edit.LotoAmtGerente.value).toFixed(2);
        }
        if (isNaN(parseFloat(document.closecash_edit.valeAmtGerente.value))) {
            valeAmtGerente_NaN = 0;
        } else {
            valeAmtGerente_NaN = parseFloat(document.closecash_edit.valeAmtGerente.value).toFixed(2);
        }
        if (isNaN(parseFloat(document.closecash_edit.CashAmtGerente.value))) {
            CashAmtGerente_NaN = 0;
        } else {
            CashAmtGerente_NaN = parseFloat(document.closecash_edit.CashAmtGerente.value).toFixed(2);
        }
        if (isNaN(parseFloat(document.closecash_edit.CoinRollGerente.value))) {
            CoinRollGerente_NaN = 0;
        } else {
            CoinRollGerente_NaN = parseFloat(document.closecash_edit.CoinRollGerente.value).toFixed(2);
        }
        if (isNaN(parseFloat(document.closecash_edit.InvoiceAmtGerente.value))) {
            InvoiceAmtGerente_NaN = 0;
        } else {
            InvoiceAmtGerente_NaN = parseFloat(document.closecash_edit.InvoiceAmtGerente.value).toFixed(2);
        }
        if (isNaN(parseFloat(document.closecash_edit.VoucherAmtGerente.value))) {
            VoucherAmtGerente_NaN = 0;
        } else {
            VoucherAmtGerente_NaN = parseFloat(document.closecash_edit.VoucherAmtGerente.value).toFixed(2);
        }
        if (isNaN(parseFloat(document.closecash_edit.InvoiceAmtPropiasGerente.value))) {
            InvoiceAmtPropiasGerente_NaN = 0;
        } else {
            InvoiceAmtPropiasGerente_NaN = parseFloat(document.closecash_edit.InvoiceAmtPropiasGerente.value)
                .toFixed(2);
        }
        if (isNaN(parseFloat(document.closecash_edit.GrantAmtGerente.value))) {
            GrantAmtGerente_NaN = 0;
        } else {
            GrantAmtGerente_NaN = parseFloat(document.closecash_edit.GrantAmtGerente.value).toFixed(2);
        }
        ///clave
        if (isNaN(parseFloat(document.closecash_edit.CardClaveGerente.value))) {
            CardClaveGerente_NaN = 0;
        } else {
            CardClaveGerente_NaN = parseFloat(document.closecash_edit.CardClaveGerente.value).toFixed(2);
        }
        ///
        if (isNaN(parseFloat(document.closecash_edit.CardValeGerente.value))) {
            CardValeGerente_NaN = 0;
        } else {
            CardValeGerente_NaN = parseFloat(document.closecash_edit.CardValeGerente.value).toFixed(2);
        }

        if (isNaN(parseFloat(document.closecash_edit.CardVisaGerente.value))) {
            CardVisaGerente_NaN = 0;
        } else {
            CardVisaGerente_NaN = parseFloat(document.closecash_edit.CardVisaGerente.value).toFixed(2);
        }

        if (isNaN(parseFloat(document.closecash_edit.CardMasterGerente.value))) {
            CardMasterGerente_NaN = 0;
        } else {
            CardMasterGerente_NaN = parseFloat(document.closecash_edit.CardMasterGerente.value).toFixed(2);
        }
        if (isNaN(parseFloat(document.closecash_edit.CardAEGerente.value))) {
            CardAEGerente_NaN = 0;
        } else {
            CardAEGerente_NaN = parseFloat(document.closecash_edit.CardAEGerente.value).toFixed(2);
        }
        if (isNaN(parseFloat(document.closecash_edit.CardBACGerente.value))) {
            CardBACGerente_NaN = 0;
        } else {
            CardBACGerente_NaN = parseFloat(document.closecash_edit.CardBACGerente.value).toFixed(2);
        }
...
function clonx_oneamtFiscalizadora() { document.closecash_edit.x_oneamtGerente.value = document.closecash_edit.x_oneamtFiscalizadora.value; }
function clonx_fiveamtFiscalizadora() { document.closecash_edit.x_fiveamtGerente.value = document.closecash_edit.x_fiveamtFiscalizadora.value; }
function clonx_tenamtFiscalizadora() { document.closecash_edit.x_tenamtGerente.value = document.closecash_edit.x_tenamtFiscalizadora.value; }
function clonx_twentyamtFiscalizadora() { document.closecash_edit.x_twentyamtGerente.value = document.closecash_edit.x_twentyamtFiscalizadora.value; }
function clonx_fiftyamtFiscalizadora() { document.closecash_edit.x_fiftyamtGerente.value = document.closecash_edit.x_fiftyamtFiscalizadora.value; }
function clonx_hundredamtFiscalizadora() { document.closecash_edit.x_hundredamtGerente.value = document.closecash_edit.x_hundredamtFiscalizadora.value; }
function clonyappyFiscalizadora() { document.closecash_edit.yappyGerente.value = document.closecash_edit.yappyFiscalizadora.value; }
function clonotrosFiscalizadora() { document.closecash_edit.otrosGerente.value = document.closecash_edit.otrosFiscalizadora.value; }
function clonotrosprimeroFiscalizadora() { document.closecash_edit.otrosprimeroGerente.value = document.closecash_edit.otrosprimeroFiscalizadora.value; }
function clonvalespagodaFiscalizadora() { document.closecash_edit.valespagodaGerente.value = document.closecash_edit.valespagodaFiscalizadora.value; }
function clonCheckAmtFiscalizadora() { document.closecash_edit.CheckAmtGerente.value = document.closecash_edit.CheckAmtFiscalizadora.value; }
function clonLotoAmtFiscalizadora() { document.closecash_edit.LotoAmtGerente.value = document.closecash_edit.LotoAmtFiscalizadora.value; }
function clonvaleAmtFiscalizadora() { document.closecash_edit.valeAmtGerente.value = document.closecash_edit.valeAmtFiscalizadora.value; }
function clonCardClaveFiscalizadora() { document.closecash_edit.CardClaveGerente.value = document.closecash_edit.CardClaveFiscalizadora.value; }
function clonCardValeFiscalizadora() { document.closecash_edit.CardValeGerente.value = document.closecash_edit.CardValeFiscalizadora.value; }
function clonCardVisaFiscalizadora() { document.closecash_edit.CardVisaGerente.value = document.closecash_edit.CardVisaFiscalizadora.value; }
function clonCardMasterFiscalizadora() { document.closecash_edit.CardMasterGerente.value = document.closecash_edit.CardMasterFiscalizadora.value; }
function clonCardAEFiscalizadora() { document.closecash_edit.CardAEGerente.value = document.closecash_edit.CardAEFiscalizadora.value; }
function clonCardBACFiscalizadora() { document.closecash_edit.CardBACGerente.value = document.closecash_edit.CardBACFiscalizadora.value; }
function clonCashAmtFiscalizadora() { document.closecash_edit.CashAmtGerente.value = document.closecash_edit.CashAmtFiscalizadora.value; }
function clonCoinRollFiscalizadora() { document.closecash_edit.CoinRollGerente.value = document.closecash_edit.CoinRollFiscalizadora.value; }
function clonInvoiceAmtFiscalizadora() { document.closecash_edit.InvoiceAmtGerente.value = document.closecash_edit.InvoiceAmtFiscalizadora.value; }
function clonInvoiceAmtPropiasFiscalizadora() { document.closecash_edit.InvoiceAmtPropiasGerente.value = document.closecash_edit.InvoiceAmtPropiasFiscalizadora.value; }
function clonVoucherAmtFiscalizadora() { document.closecash_edit.VoucherAmtGerente.value = document.closecash_edit.VoucherAmtFiscalizadora.value; }
function clonGrantAmtFiscalizadora() { document.closecash_edit.GrantAmtGerente.value = document.closecash_edit.GrantAmtFiscalizadora.value; }
function clonSencilloSupervisoraFiscalizadora(){document.closecash_edit.SencilloSupervisoraGerente.value = document.closecash_edit.SencilloSupervisoraFiscalizadora.value;}
function clontotalPanaderiaFiscalizadora(){document.closecash_edit.totalPanaderiaGerente.value = document.closecash_edit.totalPanaderiaFiscalizadora.value;}
function clontotalPagatodoFiscalizadora(){document.closecash_edit.totalPagatodoGerente.value = document.closecash_edit.totalPagatodoFiscalizadora.value;}
function clontotalsuperFiscalizadora(){document.closecash_edit.totalsuperGerente.value = document.closecash_edit.totalsuperFiscalizadora.value;}
function clondineroTaxiFiscalizadora(){document.closecash_edit.dineroTaxiGerente.value = document.closecash_edit.dineroTaxiFiscalizadora.value;}
function clonvueltoMercadoFiscalizadora(){document.closecash_edit.vueltoMercadoGerente.value = document.closecash_edit.vueltoMercadoFiscalizadora.value;}
