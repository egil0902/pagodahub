    ...
    function cal() {
        try {
            ...
            document.getElementById("otrosFiscalizadora_r").innerHTML = parseFloat((document.closecash_edit
                .otrosFiscalizadora.value) - (document.closecash_edit.otrosSistema.value)).toFixed(2);
