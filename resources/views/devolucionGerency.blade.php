    ...
    <div class="d-flex">
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-header">Inicio de bancos</div>
                <div class="card-body">
                    <!-- Formulario para envio-->
                    <form name="provider" id="provider" method="post" action="{{route( 'devgerency.create' )}}">
        ...
        <div class="card">
            ...
            <div class="card-body">
                @livewire('App\Http\Livewire\DevolucionGerencySearch')
            </div>
        </div>
    </div>
    </div>
