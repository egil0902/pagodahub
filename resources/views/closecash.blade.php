                ...
                <table class="table table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th>
                                <div style="visibility: hidden;" class="col borde text-success" id="CardClaveGerente_t">0.0</div>
                            </th>
                            <td align="right">
                                <div style="visibility: hidde;" class="col borde text-success" id="CardClaveGerente_r">0.0</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <th>
                                <div style="visibility: hidden;" class="col borde text-success" id="CardVisaGerente_t">0.0</div>
                            </th>
                            <td align="right">
                                <div class="col borde text-success" id="CardVisaGerente_r">0.0</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <th>
                                <div style="visibility: hidden;" style="visibility: hidde;" class="col borde text-success" id="CardMasterGerente_t">0.0</div>
                            </th>
                            <td align="right">
                                <div style="visibility: hidde;" class="col borde text-success" id="CardMasterGerente_r">0.0</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <th>
                                <div style="visibility: hidden;" style="visibility: hidde;" class="col borde text-success" id="CardAEGerente_t">0.0</div>
                            </th>
                            <td align="right">
                                <div style="visibility: hidde;" class="col borde text-success" id="CardAEGerente_r">0.0</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <th>
                                <div style="visibility: hidden;" style="visibility: hidde;" class="col borde text-success" id="CardBACGerente_t">0.0</div>
                            </th>
                            <td align="right">
                                <div style="visibility: hidde;" class="col borde text-success" id="CardBACGerente_r">0.0</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <th>
                                <div style="visibility: hidden;" class="col borde text-success" id="CashAmtGerente_t">0.0</div>
                            </th>
                            <td align="right">
                                <div class="col borde text-success" id="CashAmtGerente_r">0.0</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <th>
                                <div style="visibility: hidden;" class="col borde text-success" id="CoinRollGerente_t">0.0</div>
                            </th>
                            <td align="right">
                                <div class="col borde text-success" id="CoinRollGerente_r">0.0</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <th>
                                <div style="visibility: hidden;" class="col borde text-success" id="InvoiceAmtGerente_t">0.0</div>
                            </th>
                            <td align="right">
                ...
                <table class="table table-borderless">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 100px;">
                                <h5 class="mb-0 fw-bold" id="Monto_contado_Gerente" align="right">
...
<script>
    ...
    function cal() {
        ...
        if (document.getElementById("Fiscalizadora_t").innerHTML < 0) {
        ...
        if (document.getElementById("Otros_Fiscalizadora_t").innerHTML < 0) {
        ...
        if (document.getElementById("Monto_contado_Fiscalizadora").innerHTML < 0) {
        ...
        document.getElementById("Monto_Gerente_t").innerHTML = parseFloat(parseFloat(document.getElementById("Gerente_t").innerHTML) + parseFloat(document.getElementById("Otros_Gerente_t").innerHTML)).toFixed(2);
        document.getElementById("Monto_contado_Gerente").innerHTML = parseFloat(document.getElementById("Otros_Gerente_t").innerHTML - document.getElementById("InicioCaja").innerHTML).toFixed(2);
