                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> <input style="width: 100px;" name="x_oneamtSistema"
                                                            value="{{ $data->x_oneamt }}" type="number" readonly
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input style="width: 100px;" name="x_fiveamtSistema"
                                                            value="{{ $data->x_fiveamt }}" type="number" readonly
                                                            class="text-left" placeholder="0.00"></td>
                                                    <td align="right">
                                                        @php
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input style="width: 100px;" name="x_tenamtSistema"
                                                            value="{{ $data->x_tenamt }}" type="number" readonly
                                                            class="text-left" placeholder="0.00"></td>
                                                    <td align="right">
                                                        @php
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> <input style="width: 100px;" name="yappySistema"
                                                            value="{{ $data->yappy }}" type="number" step="0.01"
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input style="width: 100px;" name="otrosSistema"
                                                            value="{{ $data->otros }}" type="number" step="0.01"
                                                            readonly placeholder="0.00"></td>
                                                    <td></td>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input style="width: 100px;" name="valespagodaSistema"
                                                            value="{{ $data->valespagoda }}" type="number"
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <input style="width: 100px;" name="CheckAmtSistema"
                                                            value="{{ $data->CheckAmt }}" type="number" step="0.01"
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <input style="width: 100px;" name="LotoAmtSistema"
                                                            value="{{ $data->LotoAmt }}" type="number" step="0.01"
                                                            readonly placeholder="0.00">
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <input style="width: 100px;" name="valeAmt"
                                                            value="{{ $data->CreditAmt }}" type="number" step="0.01"
                                                            readonly placeholder="0.00">
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <input style="width: 100px;" name="CardAmtSistema"
                                                            value="{{ $data->CardAmt }}" type="number" step="0.01"
                                                            readonly placeholder="0.00">
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input style="width: 100px;" name="CashAmtSistema"
                                                            value="{{ $data->CashAmt }}" type="number" step="0.01"
                                                            readonly placeholder="0.00">
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <input style="width: 100px;" name="CoinRollSistema"
                                                            value="{{ $data->CoinRoll }}" type="number" step="0.01"
                                                            readonly placeholder="0.00">
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <input style="width: 100px;" name="InvoiceAmtSistema"
                                                            value="{{ $data->InvoiceAmt }}" type="number"
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <input style="width: 100px;" name="VoucherAmtSistema"
                                                            value="{{ $data->VoucherAmt }}" type="number"
                                                            step="0.01" readonly placeholder="0.00">
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <input style="width: 100px;" name="GrantAmtSistema"
                                                            value="{{ $data->GrantAmt }}" type="number" step="0.01"
                                                            readonly placeholder="0.00">
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="width: 100px;"><input style="width: 100px;"
                                                            ...
                                                            name="x_oneamtFiscalizadora" type="number" class="text-left"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <div class="col borde text-success"
                                                            id="x_twentyamtFiscalizadora_r" style="padding-left: 10px;">
                                                            0.00</div>
                                                    </td>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <div class="col borde text-success"
                                                            id="x_hundredamtFiscalizadora_r" style="padding-left: 10px;">
                                                            0.00</p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table table-borderless">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input style="width: 100px;"
                                                            value="{{ $dataday->yappyFiscalizadora }}"
                                                            name="otrosFiscalizadora" type="number" step="0.01"
                                                            placeholder="0.00" onchange="cal();clon();cal();colores()"
                                                            onkeyup="cal();clon();cal();colores()"></td>
                                                    <td></td>
                                                    <td align="right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input style="width: 100px;"
                                                            ...
                                                            name="valespagodaFiscalizadora" type="number" step="0.01"
                                                            placeholder="0.00" onchange="cal();clon();cal();colores()"
                                                            onkeyup="cal();clon();cal();colores()"></td>
                                                    <td></td>
                                                    <td align="right">
                                                        <div class="col borde text-success"
                                                            id="valespagodaFiscalizadora_r">
                                                            0.0</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td> <input style="width: 100px;"
                                                            ...
                                                            name="CheckAmtFiscalizadora" type="number" step="0.01"
                                                            placeholder="0.00" onchange="cal();clon();cal();colores()"
                                                            onkeyup="cal();clon();cal();colores()"></td>
                                                    <td></td>
                                                    <td align="right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <input style="width: 100px;"
                                                            ...
                                                            name="LotoAmtFiscalizadora" type="number" step="0.01"
                                                            placeholder="0.00" onchange="cal();clon();cal();colores()"
                                                            onkeyup="cal();clon();cal();colores()"></td>
                                                    <td></td>
                                                    <td align="right">
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="width: 100px;">
                                                        <h5 class="mb-0 fw-bold text-success"
                                                            id="Monto_contado_Fiscalizadora" align="right">
                                        ...
                                        <table class="table table-borderless">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input name="totalPanaderiaFiscalizadora"
                                                            value="{{ $dataday->totalPanaderiaFiscalizadora }}"
                                                            type="number" step="0.01" style="width: 100px;"
                                                            placeholder="0.00"></td>
                                                    <td></td>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input name="totalPagatodoFiscalizadora"
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <input name="totalsuperFiscalizadora"
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input name="dineroTaxiFiscalizadora"
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input name="vueltoMercadoFiscalizadora"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-borderless">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 100px;">
                                                        <h5 align="right" class="mb-0 fw-bold text-success"
                                                            id="Gerente_t">
                                                            {{ $data->x_oneamt * 1 + $data->x_fiveamt * 5 + $data->x_tenamt * 10 + $data->x_twentyamt * 20 + $data->x_fiftyamt * 50 + $data->x_hundredamt * 100 }}
                                                        </h5>
                                                    </th>
                                                    <th style="width: 100px;" align="right">
                                                        <div align="right" style="font-size:12px;">Diferencia</div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>$1x</td>
                                                    <td>
                                                        <input style="width: 100px;" name="x_oneamtGerente"
                                                            value="{{ $dataday->x_oneamtGerente }}" type="number"
                                                            class="text-left" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()" />
                                                    </td>
                                                    <td align="right">
                                                        <div class="col borde" id="x_oneamtGerente_t">
                                                            {{ $data->x_oneamt * 1 }}</div>
                                                    </td>
                                                    <td align="right">
                                                ...
                                                <tr>
                                                    <td>$5x</td>
                                                    <td> <input style="width: 100px;" name="x_fiveamtGerente"
                                                            value="{{ $dataday->x_fiveamtGerente }}" type="number"
                                                            class="text-left" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()">
                                                    </td>
                                                    <td align="right">
                                                ...
                                                <tr>
                                                    <td>$10x</td>
                                                    <td> <input style="width: 100px;" name="x_tenamtGerente"
                                                            value="{{ $dataday->x_tenamtGerente }}" type="number"
                                                            class="text-left" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()">
                                                    </td>
                                                    <td align="right">
                                                ...
                                                <tr>
                                                    <td>$20x</td>
                                                    <td> <input style="width: 100px;" name="x_twentyamtGerente"
                                                            value="{{ $dataday->x_twentyamtGerente }}" value=""
                                                ...
                                                <tr>
                                                    <td>$50x</td>
                                                    <td> <input style="width: 100px;" name="x_fiftyamtGerente"
                                                            value="{{ $dataday->x_fiftyamtGerente }}" type="number"
                                                            class="text-left" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()">
                                                    </td>
                                                    <td align="right">
                                                ...
                                                <tr>
                                                    <td>$100x</td>
                                                    <td><input style="width: 100px;" name="x_hundredamtGerente"
                                                            value="{{ $dataday->x_hundredamtGerente }}" type="number"
                                                            class="text-left" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()">
                                                    </td>
                                                    <td align="right">
                                        ...
                                        <table class="table table-borderless">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="font-size:12px;">Yappy</td>
                                                    <td><input name="yappyGerente" value="{{ $dataday->yappyGerente }}"
                                                            type="number" step="0.01" style="width: 100px;"
                                                            placeholder="0.00" onchange="cal();colores()"
                                                            onkeyup="cal();colores()"></td>
                                                    <th>
                                                        <div style="visibility: hidden;" class="col borde text-success"
                                                ...
                                                <tr>
                                                    <td style="font-size:12px;">Otros</td>
                                                    <td>
                                                        <input name="otrosGerente" value="{{ $dataday->otrosGerente }}"
                                                            type="number" step="0.01" style="width: 100px;"
                                                            placeholder="0.00" onchange="cal();colores()"
                                                            onkeyup="cal();colores()">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="font-size:12px;">Vales Pagoda </td>
                                                    <td>
                                                        <input name="valespagodaGerente"
                                                            value="{{ $dataday->valespagodaGerente }}" type="number"
                                                ...
                                                <tr>
                                                    <td style="font-size:12px;"> Monto cheques</td>
                                                    <td>
                                                        <input name="CheckAmtGerente"
                                                            value="{{ $dataday->CheckAmtGerente }}" type="number"
                                                            step="0.01" style="width: 100px;" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()">
                                                    </td>
                                                    <th>
                                                ...
                                                <tr>
                                                    <td style="font-size:12px;"> Loteria</td>
                                                    <td>
                                                        <input name="LotoAmtGerente"
                                                            value="{{ $dataday->LotoAmtGerente }}" type="number"
                                                            step="0.01" style="width: 100px;" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()">
                                                    </td>
                                                    <th>
                                                ...
                                                <tr>
                                                    <td style="font-size:12px;">Vale</td>
                                                    <td><input name="valeAmtGerente"
                                                            value="{{ $dataday->valeAmtGerente }}" type="number"
                                                            step="0.01" style="width: 100px;" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()"></td>
                                                    <th>
                                                        <div style="visibility: hidden;" class="col borde"
                                                            id="valeAmtGerente_t">0.0</div>
                                                    </th>
                                                    <td align="right">
                                                        <div class="col borde text-success" id="valeAmtGerente_r">0.00
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size:12px;">Tarjeta Clave</td>
                                                    <td><input name="CardClaveGerente"
                                                            value="{{ $dataday->CardClaveGerente }}" type="number"
                                                            step="0.01" style="width: 100px;" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()"></td>
                                                    <th>
                                                        <div style="visibility: hidden;" class="col borde text-success"
                                                    ...
                                                    <td align="right">
                                                        <div style="visibility: hidde;" class="col borde text-success"
                                                            id="CardClaveGerente_r">0.00</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size:12px;">Tarjeta Vale</td>
                                                    <td>
                                                        <input name="CardValeGerente"
                                                            value="{{ $dataday->CardValeGerente }}" type="number"
                                                            step="0.01" style="width: 100px;" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()">
                                                    </td>
                                                    <th>
                                                    ...
                                                    <td align="right">
                                                        <div style="visibility: hidde;" class="col borde text-success"
                                                            id="CardValeGerente_r">0.00</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size:12px;">Tarjeta Visa</td>
                                                    <td>
                                                        <input name="CardVisaGerente"
                                                            value="{{ $dataday->CardVisaGerente }}" type="number"
                                                            step="0.01" style="width: 100px;" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()">
                                                    </td>
                                                    <th>
                                                        <div style="visibility: hidden;" class="col borde text-success"
                                                            id="CardVisaGerente_t">0.00</div>
                                                    </th>
                                                    <td align="right">
                                                        <div class="col borde text-success" id="CardVisaGerente_r">0.00
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size:12px;">Tarjeta Master</td>
                                                    <td>
                                                        <input name="CardMasterGerente"
                                                            value="{{ $dataday->CardMasterGerente }}" type="number"
                                                            step="0.01" style="width: 100px;" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()">
                                                    </td>
                                                    <th>
                                                    ...
                                                    <td align="right">
                                                        <div style="visibility: hidde;" class="col borde text-success"
                                                            id="CardMasterGerente_r">0.00</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size:12px;">Tarjeta American</td>
                                                    <td>
                                                        <input name="CardAEGerente" value="{{ $dataday->CardAEGerente }}"
                                                            type="number" step="0.01" style="width: 100px;"
                                                            placeholder="0.00" onchange="cal();colores()"
                                                            onkeyup="cal();colores()">
                                                    </td>
                                                    ...
                                                    <td align="right">
                                                        <div style="visibility: hidde;" class="col borde text-success"
                                                            id="CardAEGerente_r">0.00</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size:12px;">Tarjeta BAC</td>
                                                    <td><input name="CardBACGerente"
                                                            value="{{ $dataday->CardBACGerente }}" type="number"
                                                            step="0.01" style="width: 100px;" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()"></td>
                                                    <th>
                                                        <div style="visibility: hidden;" style="visibility: hidde;"
                                                    ...
                                                    <td align="right">
                                                        <div style="visibility: hidde;" class="col borde text-success"
                                                            id="CardBACGerente_r">0.00</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size:12px;">Sencillo</td>
                                                    <td>
                                                        <input name="CashAmtGerente"
                                                            value="{{ $dataday->CashAmtGerente }}" type="number"
                                                            step="0.01" style="width: 100px;" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()">
                                                    </td>
                                                    <th>
                                                ...
                                                <tr>
                                                    <td style="font-size:12px;">Rollos </td>
                                                    <td>
                                                        <input name="CoinRollGerente"
                                                            value="{{ $dataday->CoinRollGerente }}" type="number"
                                                            step="0.01" style="width: 100px;" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()">
                                                    </td>
                                                    <th>
                                                ...
                                                <tr>
                                                    <td style="font-size:12px;">Facturas </td>
                                                    <td>
                                                        <input name="InvoiceAmtGerente"
                                                            value="{{ $dataday->InvoiceAmtGerente }}" type="number"
                                                            step="0.01" style="width: 100px;" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()">
                                                    </td>
                                                    <th>
                                                ...
                                                <tr>
                                                    <td style="font-size:12px;">Facturas Propias</td>
                                                    <td>
                                                        <input name="InvoiceAmtPropiasGerente"
                                                ...
                                                <tr>
                                                    <td style="font-size:12px;">Vale digital </td>
                                                    <td>
                                                        <input name="VoucherAmtGerente"
                                                            value="{{ $dataday->VoucherAmtGerente }}" type="number"
                                                            step="0.01" style="width: 100px;" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()">
                                                    </td>
                                                    <th>
                                                ...
                                                <tr>
                                                    <td style="font-size:12px;">Beca Digital </td>
                                                    <td>
                                                        <input name="GrantAmtGerente"
                                                            value="{{ $dataday->GrantAmtGerente }}" type="number"
                                                            step="0.01" style="width: 100px;" placeholder="0.00"
                                                            onchange="cal();colores()" onkeyup="cal();colores()">
                                                    </td>
                                                    <th>
                                    ...
                                    <div class="col">
                                        <div class="card-body">
                                            <label for="formFileMultiple" class="form-label">Por favor adjunte los
                                                reportes</label>
                                            <input class="form-control" type="file" id="Fileclosecash"
                                                name="Fileclosecash" value="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Vales Pagoda </td>
                                            <td><input style="width: 100px;" name="valespagodaSistema"
                                                    value="{{ $data->valespagoda }}" type="number" step="0.01"
                                                    readonly placeholder="0.00"></td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Facturas </td>
                                            <td> <input style="width: 100px;" name="InvoiceAmtSistema"
                                                    value="{{ $data->InvoiceAmt }}" type="number" step="0.01"
                                                    readonly placeholder="0.00">
                                            </td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td style="font-size:12px; ">Vale digital </td>
                                            <td> <input style="width: 100px;" name="VoucherAmtSistema"
                                                    value="{{ $data->VoucherAmt }}" type="number" step="0.01"
                                                    readonly placeholder="0.00">
                                            </td>
                                            <td></td>
                                            <td></td>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width: 100px;">$1x</td>
                                            <td style="width: 100px;"><input style="width: 100px;" value=""
                                                    name="x_oneamtFiscalizadora" type="number" class="text-left"
                                                    placeholder="0.00" onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()">
                                            </td>
                                        ...
                                        <tr>
                                            <td>$5x</td>
                                            <td><input style="width: 100px;" value=""
                                        ...
                                        <tr>
                                            ...
                                            <td align="right">
                                                <div class="col borde text-success" id="x_hundredamtFiscalizadora_r"
                                                    style="padding-left: 10px;">0.00</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="table table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="font-size:12px;">Yappy</td>
                                            <td><input style="width: 100px;" value="" id="yappyFiscalizadora"
                                                    name="yappyFiscalizadora" value="" type="number"
                                                    step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()">
                                            </td>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Otros</td>
                                            <td><input style="width: 100px;" value="" name="otrosFiscalizadora"
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Vales Pagoda </td>
                                            <td><input style="width: 100px;" value=""
                                                    name="valespagodaFiscalizadora" value="" type="number"
                                                    step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;"> Monto cheques</td>
                                            <td> <input style="width: 100px;" value=""
                                                    name="CheckAmtFiscalizadora" value="" type="number"
                                                    step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"></td>
                                            <td></td>
                                            <td align="right">
                                                <div class="col borde text-success" id="CheckAmtFiscalizadora_r">0.0
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:12px;">Loteria</td>
                                            <td> <input style="width: 100px;" value=""
                                                    name="LotoAmtFiscalizadora" value="" type="number"
                                                    step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"></td>
                                            <td></td>
                                            <td align="right">
                                                <div class="col borde text-success" id="LotoAmtFiscalizadora_r">0.0
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:12px;">Vale</td>
                                            <td><input style="width: 100px;" value=""
                                                    name="valeAmtFiscalizadora" value="" type="number"
                                                    step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"></td>
                                            <td></td>
                                            <td align="right">
                                                <div class="col borde text-success" id="valeAmtFiscalizadora_r">0.0
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:12px;">Tarjeta Clave</td>
                                            <td><input style="width: 100px;" value=""
                                                    name="CardClaveFiscalizadora" value="" type="number"
                                                    step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Tarjeta Vale</td>
                                            <td><input style="width: 100px;" value=""
                                                    name="CardValeFiscalizadora" value="" type="number"
                                                    step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Tarjeta Visa</td>
                                            <td><input style="width: 100px;" value=""
                                                    name="CardVisaFiscalizadora" value="" type="number"
                                                    step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"></td>
                                            <td></td>
                                            <td align="right">
                                                <div class="col borde text-success" id="CardVisaFiscalizadora_r">0.0
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:12px;">Tarjeta Master</td>
                                            <td><input style="width: 100px;" value=""
                                                    name="CardMasterFiscalizadora" value="" type="number"
                                                    step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Tarjeta American</td>
                                            <td><input style="width: 100px;" value="" name="CardAEFiscalizadora"
                                                    value="" type="number" step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Tarjeta BAC</td>
                                            <td><input style="width: 100px;" value=""
                                                    name="CardBACFiscalizadora" value="" type="number"
                                                    step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td align="right">
                                                <div class="col borde text-success" id="CashAmtFiscalizadora_r">0.0
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:12px;">Rollos </td>
                                            <td><input style="width: 100px;" value=""
                                                    name="CoinRollFiscalizadora" value="" type="number"
                                                    step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"> </td>
                                            <td></td>
                                            <td align="right">
                                                <div class="col borde text-success" id="CoinRollFiscalizadora_r">0.0
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:12px;">Facturas</td>
                                            <td><input style="width: 100px;" value=""
                                                    name="InvoiceAmtFiscalizadora" value="" type="number"
                                                    step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"> </td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Facturas Propias</td>
                                            <td><input style="width: 100px;" value=""
                                                    name="InvoiceAmtPropiasFiscalizadora" value=""
                                                    type="number" step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"> </td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Vale digital </td>
                                            <td><input style="width: 100px;" value=""
                                                    name="VoucherAmtFiscalizadora" value="" type="number"
                                                    step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"> </td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Beca Digital </td>
                                            <td><input style="width: 100px;" value=""
                                                    name="GrantAmtFiscalizadora" value="" type="number"
                                                    step="0.01" placeholder="0.00"
                                                    onchange="cal();clon();cal();colores()"
                                                    onkeyup="cal();clon();cal();colores()"> </td>
                                            <td></td>
                                            <td align="right">
                                                <div class="col borde text-success" id="GrantAmtFiscalizadora_r">0.0
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="font-size:12px;">Total Panaderia</td>
                                            <td><input name="totalPanaderiaFiscalizadora" value=""
                                                    type="number" step="0.01" style="width: 100px;"
                                                    placeholder="0.00"></td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Total Pagatodo</td>
                                            <td><input name="totalPagatodoFiscalizadora" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"></td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:12px;">Total Super</td>
                                            <td> <input name="totalsuperFiscalizadora" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"> </td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:12px;">Dinero de Taxi</td>
                                            <td><input name="dineroTaxiFiscalizadora" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"> </td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:12px;"> Vuelto de mercado</td>
                                            <td><input name="vueltoMercadoFiscalizadora" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"></td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>$1x</td>
                                            <td>
                                                <input style="width: 100px;" name="x_oneamtGerente" value=""
                                                    type="number" class="text-left" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()" />
                                            </td>
                                            <td align="right">
                                        ...
                                        <tr>
                                            <td>$5x</td>
                                            <td> <input style="width: 100px;" name="x_fiveamtGerente" value=""
                                                    type="number" class="text-left" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <td align="right">
                                        ...
                                        <tr>
                                            <td>$10x</td>
                                            <td> <input style="width: 100px;" name="x_tenamtGerente" value=""
                                                    type="number" class="text-left" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <td align="right">
                                        ...
                                        <tr>
                                            <td>$20x</td>
                                            <td> <input style="width: 100px;" name="x_twentyamtGerente" value=""
                                                    type="number" class="text-left" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <td align="right">
                                        ...
                                        <tr>
                                            <td>$50x</td>
                                            <td> <input style="width: 100px;" name="x_fiftyamtGerente" value=""
                                                    type="number" class="text-left" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <td align="right">
                                        ...
                                        <tr>
                                            <td>$100x</td>
                                            <td><input style="width: 100px;" name="x_hundredamtGerente" value=""
                                                    type="number" class="text-left" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <td align="right">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="font-size:12px;">Yappy</td>
                                            <td><input name="yappyGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()"></td>
                                            <th>
                                                <div style="visibility: hidden;" class="col borde text-success"
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Otros</td>
                                            <td>
                                                <input name="otrosGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <th>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Vales Pagoda </td>
                                            <td>
                                                <input name="valespagodaGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <th>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;"> Monto cheques</td>
                                            <td>
                                                <input name="CheckAmtGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <th>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;"> Loteria</td>
                                            <td>
                                                <input name="LotoAmtGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <th>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Vale</td>
                                            <td><input name="valeAmtGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()"></td>
                                            <th>
                                                <div style="visibility: hidden;" class="col borde"
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Tarjeta Clave</td>
                                            <td><input name="CardClaveGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()"></td>
                                            <th>
                                                <div style="visibility: hidden;" class="col borde text-success"
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Tarjeta Vale</td>
                                            <td>
                                                <input name="CardValeGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <th>
                                                <div style="visibility: hidden;" style="visibility: hidde;"
                                                    class="col borde text-success" id="CardValeGerente_t">0.0</div>
                                            </th>
                                            <td align="right">
                                                <div style="visibility: hidde;" class="col borde text-success"
                                                    id="CardValeGerente_r">0.00</div>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Tarjeta Visa</td>
                                            <td>
                                                <input name="CardVisaGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <th>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Tarjeta Master</td>
                                            <td>
                                                <input name="CardMasterGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <th>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Tarjeta American</td>
                                            <td>
                                                <input name="CardAEGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <th>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Tarjeta BAC</td>
                                            <td><input name="CardBACGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()"></td>
                                            <th>
                                                <div style="visibility: hidden;" style="visibility: hidde;"
                                                    class="col borde text-success" id="CardBACGerente_t">0.00</div>
                                            </th>
                                            <td align="right">
                                                <div style="visibility: hidde;" class="col borde text-success"
                                                    id="CardBACGerente_r">0.00</div>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Sencillo</td>
                                            <td>
                                                <input name="CashAmtGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <th>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Rollos </td>
                                            <td>
                                                <input name="CoinRollGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <th>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Facturas </td>
                                            <td>
                                                <input name="InvoiceAmtGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <th>
                                            ...
                                            <td align="right">
                                                <div class="col borde text-success" id="InvoiceAmtGerente_r">0.00
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:12px;">Facturas Propias</td>
                                            <td>
                                                <input name="InvoiceAmtPropiasGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <th>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Vale digital </td>
                                            <td>
                                                <input name="VoucherAmtGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <th>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Beca Digital </td>
                                            <td>
                                                <input name="GrantAmtGerente" value="" type="number"
                                                    step="0.01" style="width: 100px;" placeholder="0.00"
                                                    onchange="cal();colores()" onkeyup="cal();colores()">
                                            </td>
                                            <th>
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="font-size:12px;">Total Panaderia</td>
                                            <td><input name="totalPanaderiaGerente" value=""
                                                    style="width: 100px;" type="number" step="0.01"
                                                    placeholder="0.00"></td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Total Pagatodo</td>
                                            <td><input name="totalPagatodoGerente" value=""
                                                    style="width: 100px;" type="number" step="0.01"
                                                    placeholder="0.00"></td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td style="font-size:12px;">Total Super</td>
                                            <td> <input name="totalsuperGerente" value="" style="width: 100px;"
                                                    type="number" step="0.01" placeholder="0.00"> </td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:12px;">Dinero de Taxi</td>
                                            <td><input name="dineroTaxiGerente" value="" style="width: 100px;"
                                                    type="number" step="0.01" placeholder="0.00"> </td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:12px;"> Vuelto de mercado</td>
                                            <td><input name="vueltoMercadoGerente" value=""
                                                    style="width: 100px;" type="number" step="0.01"
                                                    placeholder="0.00"></td>
                                            <td></td>
                                            <td></td>
...
<script>
    ...
    function cal() {
        try {
            ...
            document.getElementById("otrosFiscalizadora_r").innerHTML = parseFloat((document.closecash_store
                .otrosFiscalizadora.value) - (document.closecash_store.otrosSistema.value)).toFixed(2);
            ...
            document.getElementById("InvoiceAmtPropiasGerente_r").innerHTML = parseFloat(document.closecash_store
                .InvoiceAmtPropiasGerente.value - document.closecash_store.InvoiceAmtFiscalizadora.value).toFixed(2);
    ...
    function clon() {
        ...
        document.closecash_store.InvoiceAmtPropiasGerente.value = document.closecash_store
            .InvoiceAmtPropiasFiscalizadora.value;
