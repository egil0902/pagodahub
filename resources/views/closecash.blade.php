                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        ...
                                        <th> </th>
                                        <th align="right">
                                            <h5 align="right" class="mb-0 fw-bold text-success" id="Fiscalizadora_t">
                                            </h5>
                                        </th>
                                        <th align="right">
                            ...
                            <table class="table table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input style="width: 100px;" 
                                            ...
                                            @endif
                                                ...
                                                step="0.01" placeholder="0.00" onchange="cal();clon();cal();colores()"
                                                onkeyup="cal();clon();cal();colores()">
                                        </td>
                                        <td></td>
                                        <td align="right">
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Otros</td>
                                        <td><input style="width: 100px;"  name="otrosFiscalizadora" type="number" step="0.01"
                                            placeholder="0.00" onchange="cal();clon();cal();colores()"
                                            onkeyup="cal();clon();cal();colores()" 
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Vales Pagoda </td>
                                        <td><input style="width: 100px;"  name="valespagodaFiscalizadora" type="number" step="0.01"
                                            placeholder="0.00" onchange="cal();clon();cal();colores()"
                                            onkeyup="cal();clon();cal();colores()" 
                                    ...
                                    <tr>
                                        <td style="font-size:12px;"> Monto cheques</td>
                                        <td> <input style="width: 100px;" name="CheckAmtFiscalizadora" type="number" step="0.01"
                                            placeholder="0.00" onchange="cal();clon();cal();colores()"
                                            onkeyup="cal();clon();cal();colores()" 
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Loteria</td>
                                        <td> <input style="width: 100px;" name="LotoAmtFiscalizadora" type="number" step="0.01"
                                            placeholder="0.00" onchange="cal();clon();cal();colores()"
                                            onkeyup="cal();clon();cal();colores()" 
                                    ...
                                    <tr>
                                        ...
                                        <td><input style="width: 100px;" 
                                            ...
                                            @else
                                                value=""
                                            @endif
                                                name="CashAmtFiscalizadora" value="" type="number" step="0.01"
                                                placeholder="0.00" onchange="cal();clon();cal();colores()"
                                                onkeyup="cal();clon();cal();colores()"></td>
                                        <td></td>
                                        <td align="right">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        <td>$1x</td>
                                        <td>
                                            <input style="width: 100px;" name="x_oneamtGerente" type="number" class="text-left"
                                    ...
                                    <tr>
                                        <td>$5x</td>
                                        <td> <input style="width: 100px;" name="x_fiveamtGerente" type="number"
                                    ...
                                    <tr>
                                        <td>$10x</td>
                                        <td> <input style="width: 100px;" name="x_tenamtGerente"  type="number" class="text-left"
                                            placeholder="0.00" onchange="cal();colores()" onkeyup="cal();colores()" 
                                    ...
                                    <tr>
                                        <td>$20x</td>
                                        <td> <input style="width: 100px;" name="x_twentyamtGerente" type="number"
                                            class="text-left" placeholder="0.00" onchange="cal();colores()"
                                            onkeyup="cal();colores()"  
                                    ...
                                    <tr>
                                        <td>$50x</td>
                                        <td> <input style="width: 100px;" name="x_fiftyamtGerente" type="number"
                                            class="text-left" placeholder="0.00" onchange="cal();colores()"
                                            onkeyup="cal();colores()" 
                                    ...
                                    <tr>
                                        <td>$100x</td>
                                        <td><input style="width: 100px;" name="x_hundredamtGerente"  type="number"
                                            class="text-left" placeholder="0.00" onchange="cal();colores()"
                                            onkeyup="cal();colores()" 
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="font-size:12px;">Yappy</td>
                                        <td><input name="yappyGerente" type="number" step="0.01" style="width: 100px;" placeholder="0.00"
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Otros</td>
                                        <td>
                                            <input name="otrosGerente"  type="number" step="0.01" style="width: 100px;" placeholder="0.00"
                                            onchange="cal();colores()" onkeyup="cal();colores()" 
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Vales Pagoda </td>
                                        <td>
                                            <input name="valespagodaGerente" type="number" step="0.01" style="width: 100px;" placeholder="0.00"
                                            onchange="cal();colores()" onkeyup="cal();colores()" 
                                    ...
                                    <tr>
                                        <td style="font-size:12px;"> Monto cheques</td>
                                        <td>
                                            <input name="CheckAmtGerente"  type="number" step="0.01" style="width: 100px;" placeholder="0.00"
                                            onchange="cal();colores()" onkeyup="cal();colores()" 
                                    ...
                                    <tr>
                                        <td style="font-size:12px;"> Loteria</td>
                                        <td>
                                            <input name="LotoAmtGerente" type="number" step="0.01" style="width: 100px;" placeholder="0.00"
                                            onchange="cal();colores()" onkeyup="cal();colores()"
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Vale</td>
                                        <td><input name="valeAmtGerente" type="number" step="0.01" style="width: 100px;" placeholder="0.00"
                                            onchange="cal();colores()" onkeyup="cal();colores()" 
                                            ...
                                            @if ($list->isNotEmpty())
                                                ...
                                                ></td>
                                        <th>
                                            <div style="visibility: hidden;" class="col borde" id="valeAmtGerente_t">0.0
                                            </div>
                                        </th>
                                        <td align="right">
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Tarjeta Clave</td>
                                        <td><input name="CardClaveGerente" type="number" step="0.01" style="width: 100px;" placeholder="0.00"
                                            onchange="cal();colores()" onkeyup="cal();colores()" 
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Tarjeta Vale</td>
                                        <td>
                                            <input name="CardValeGerente" type="number" step="0.01" style="width: 100px;" placeholder="0.00"
                                            onchange="cal();colores()" onkeyup="cal();colores()" 
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Tarjeta Visa</td>
                                        <td>
                                            <input name="CardVisaGerente" type="number" step="0.01" style="width: 100px;" placeholder="0.00"
                                            onchange="cal();colores()" onkeyup="cal();colores()"
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Tarjeta Master</td>
                                        <td>
                                            <input name="CardMasterGerente" type="number" step="0.01" style="width: 100px;" placeholder="0.00"
                                            onchange="cal();colores()" onkeyup="cal();colores()" 
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Tarjeta American</td>
                                        <td>
                                            <input name="CardAEGerente" type="number" step="0.01" style="width: 100px;" placeholder="0.00"
                                            onchange="cal();colores()" onkeyup="cal();colores()" 
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Tarjeta BAC</td>
                                        <td><input name="CardBACGerente" type="number" step="0.01" style="width: 100px;" placeholder="0.00"
                                            onchange="cal();colores()" onkeyup="cal();colores()" 
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Sencillo</td>
                                        <td>
                                            <input name="CashAmtGerente" type="number" step="0.01" style="width: 100px;" placeholder="0.00"
                                            onchange="cal();colores()" onkeyup="cal();colores()" 
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Rollos </td>
                                        <td>
                                            <input name="CoinRollGerente" type="number" step="0.01" style="width: 100px;"
                                            placeholder="0.00" onchange="cal();colores()" 
                                            onkeyup="cal();colores()"
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Facturas </td>
                                        <td>
                                            <input name="InvoiceAmtGerente" type="number" step="0.01" style="width: 100px;"
                                            placeholder="0.00" onchange="cal();colores()" 
                                            onkeyup="cal();colores()"
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Vale digital </td>
                                        <td>
                                            <input name="VoucherAmtGerente" type="number" step="0.01" style="width: 100px;"
                                            placeholder="0.00" onchange="cal();colores()"
                                            onkeyup="cal();colores()" 
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">Beca Digital </td>
                                        <td>
                                            <input name="GrantAmtGerente" type="number" step="0.01" style="width: 100px;"
                                            placeholder="0.00" onchange="cal();colores()"
                                            onkeyup="cal();colores()" 
