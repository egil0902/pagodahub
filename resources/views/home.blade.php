                                        ...
                                        <center>
                                            <button type="submit" class="btn btn-outline">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">Permite el cierre diario de las cuentas para
                                                        auditoría</p>
                                                </div>
                                            </button>
                                        </center>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            <div class="col">
                                <div class="card h-100 border border-5 border-dark-subtle">
                                    <form name="loans" id="loans" method="get" action="{{ route('loans') }}">
                                        @csrf
                                        @csrf
                                        <center>
                                            <button type="submit" class="btn btn-outline">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">Administración de prestamos, registro de terceros
                                                        y
                                                        adjuntos
                                                    </p>
                                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            <div class="col">
                                <div class="card h-100 border border-5 border-dark-subtle">
                                    <form name="loanslist" id="loanslist" method="get" action="{{ route('home') }}">
                                        @csrf
                                        <center>
                                            <button type="submit" class="btn btn-outline">
                                    ...
                                    <form name="loanslist" id="loanslist" method="get" action="{{ route('home') }}">
                                        ...
                                        <center>
                                            <button type="submit" class="btn btn-outline">
                                                {{-- <h5 class="card-header">Compras</h5> --}}
                                                <div class="card-body">
                                                    <h5 class="card-title">Listado de creditos por proveedor</h5>
                                                    <p class="card-text">---------------</p>
                                                </div>
                                            </button>
                                        </center>
