                    ...
                    <div class="container">
                        <div class="row align-items-end">
                            <div class="col-md-5 col-5 col-sm-5 col-lg-5 ">
                                <label>Nro Identificación del Deudor</label>
                            ...
                            <div class="row ">
                                <center>
                                    <div class="col-3 col-lg-3 col-sm-3 col-md-3">
                                        ...
                                        <label for="formFileMultiple" class="form-label">Abjuntar Foto Cedula</label>
                            ...
                            <div class="card-body">
                                <form name="loans_store" id="loans_store" method="POST"
                                    ...
                                    <p class="fw-bold"><span class="fw-light">Cédula: </span>{{ $data->TaxID }}<span
                                            class="fw-light"> Nombre: </span>{{ $data->Name }}</p>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#bpartnerModal">Agregar Nuevo Prestamo</button>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <label for="FileCedula" class="form-label">Abjuntar Foto
                                                        Recibo</label>
                                                    <input class="form-control" type="file" id="Filecedula"
                                                   ...
                                                   <label>Firma</label>
                                                    <div>
                                                        ...
                                                        <input type="hidden" id="myText3" name="v12"
                                                            value="no guarda">
                                                    </div>
