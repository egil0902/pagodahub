                            ...
                            <div class="card-body">
                                <form name="loans_store" id="loans_store" method="POST"
                                    ...
                                    <p class="fw-bold"><span class="fw-light">Cédula: </span>{{ $data->TaxID }}<span
                                            class="fw-light"> Nombre: </span>{{ $data->Name }} <span class="fw-light">
                                            Monto total pendiente: </span></p>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#bpartnerModal">Agregar Nuevo Prestamo</button>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#bpartnerModal">Agregar Pago</button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input class="form-control" type="file" id="Filecedula"
                                                        placeholder="Recibo" name="FileCedula" value="0" accept=".png, .jpg, .jpeg">
                                                    <br> <br>
                                                    <label>Firma</label>
                                                    <div>
                                                        <center>
