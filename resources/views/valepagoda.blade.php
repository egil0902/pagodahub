        ...
        <div class="card-body">
            <div class="form-group">
                <form name="valepagoda_search" id="valepagoda_search" method="GET" action="{{ route('valepagoda.search') }}">
                    ...
                    <div class="col">
                        @if (
                            (!isset($datas) || !$datas->isEmpty() || $range->isEmpty()) &&
                    ...
                    @if (
                        ...
                        <form name="valepagoda_store" id="valepagoda_store" method="GET"
                            ...
                            <div class="row align-items-end">
                                ...
                                @if (isset($datas2))
                                    @if ($datas2->isEmpty() && !$range2->isEmpty())
                                        <input name="AD_Org_ID2" value="{{ isset($request) ? $request->AD_Org_ID : '' }}"
                                            type="hidden" class="form-control" placeholder="">
                                ...
                                @if (isset($datas3))
                                    @if ($datas3->isEmpty() && !$range3->isEmpty())
                                        <input name="AD_Org_ID3" value="{{ isset($request) ? $request->AD_Org_ID : '' }}"
                                            type="hidden" class="form-control" placeholder="">
                                ...
                                @if (isset($datas4))
                                    @if ($datas4->isEmpty() && !$range4->isEmpty())
                                        <input name="AD_Org_ID4" value="{{ isset($request) ? $request->AD_Org_ID : '' }}"
                                            type="hidden" class="form-control" placeholder="">
                                ...
                                @if (isset($datas5))
                                    @if ($datas5->isEmpty() && !$range5->isEmpty())
                                        <input name="AD_Org_ID5" value="{{ isset($request) ? $request->AD_Org_ID : '' }}"
                                            type="hidden" class="form-control" placeholder="">
